                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 search-results">
                        <div class="list-deal-wrapper">
                            ...
                            <div class="view-more-alldeal">
                                <a href="javascript:void(0);" id="js-view-more-deals" class="btn btn-view-more view-more-alldeal-link" data-target="category" data-target-id="{{ $category->id }}">
                        ...
                        @if (isset($activeCoupons) && !empty($activeCoupons))
                            ...
                            <div class="view-more-alldeal">
                                <a href="{{ route('frontend::category::listByCategory', [ 'slug' => $category->slug ]) }}" class="btn btn-view-more view-more-alldeal-link">
