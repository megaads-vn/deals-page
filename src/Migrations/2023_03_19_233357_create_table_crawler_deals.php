...
class CreateTableCrawlerDeals extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if ( !Schema::hasTable('crawler_deals') ) {
            Schema::create('crawler_deals', function (Blueprint $table) {
                $table->increments('id');
                ...
                $table->string('store_tmp')->nullable();
            ...
            DB::statement(
                'ALTER TABLE `crawler_deals` ADD INDEX `search_slug` (`search_slug`) using BTREE;');
            DB::statement('ALTER TABLE `crawler_deals` ADD INDEX `search_status` (`status`) using BTREE;');
            DB::statement('ALTER TABLE `crawler_deals` ADD INDEX `search_storeId` (`store_id`) using BTREE;');
        }
    }
    ...
    {
        Schema::dropIfExists('crawler_deals');
    }
}
