...
//    Route::get('/deals/{slug}-deals', 'DealsController@index')->name('deal::detail')->where(['slug' => '[0-9a-zA-Z\-]+']);
    ...
    Route::get("/deals", ['as' => 'frontend::store::listDeal', 'uses' => "DealsController@storeDeal"])->middleware('interceptor');
    Route::post("/deals", ['as' => 'frontend::store::listDeal', 'uses' => "DealsController@storeDeal"]);
    ...
    Route::get("/coupon-category/{slug}/deals", ["as" => 'frontend::category::deals', 'uses' => "DealsController@categoryDeals"])->middleware('interceptor');
